...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.tecforte.blog.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.tecforte.blog.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.tecforte.blog.domain.Blog.class.getName() + ".entries");
